...
- 🔬 Former **Research Intern at DRDO – Centre for Airborne Systems**, applying Python and ML in a defence R&D environment
- 🚗 Currently building an **Autonomous Vehicle Simulation System** — path planning, obstacle detection, and real-time perception in Gazebo/Isaac Sim
- 🏭 Industrial automation background: PLC programming and hydraulics/pneumatics internships at **Bosch Rexroth India**
- 📄 Published researcher — two papers on intelligent transportation systems and ML for clinical trial prediction
- 🏆 AWS AI for Bharat Hackathon participant, featured on GeeksforGeeks
- 🤝 Coordinator, IET Student Chapter — leads hackathon and academic project teams
- 🌱 Self-learning quantum computing and its intersection with AI and cryptography
...
|---|---|---|---|
| B.Tech – AI & Robotics | Dayananda Sagar University, Bengaluru | 2024–28 | CGPA: 9.2 |
| Class XII | New Sri Chaitanya | 2024 | 89% |
| Class X | Kendriya Vidyalaya | 2022 | 84.5% |

**Coursework:** Data Structures & Algorithms · Machine Learning · OOP · Agentic AI · Prompt Engineering
...
**Project Member, Autonomous Vehicles Development — Dayananda Sagar University** · Nov 2025 – Present · Hybrid
Applying research and CAD skills (Autodesk Fusion 360) to autonomous vehicle system design.

**Hydraulics and Pneumatic Intern — Bosch Rexroth India** · Jan 2026 – May 2026 · On-site
Applied training on fluid power systems integration in robotic and automated platforms.

**PLC COE Intern — Bosch Rexroth India** · Aug 2025 – Dec 2025 · Bengaluru (On-site)
Completed five industrial automation projects (embossing machine, bending tool, selective banding system) as part of PLC-based automation training.
...
<img src="https://skillicons.dev/icons?i=python,c,matlab,mysql&theme=dark" />
...
<img src="https://skillicons.dev/icons?i=ros&theme=dark" /> &nbsp; Isaac Sim · Gazebo · Autodesk Fusion 360 · PLC Programming · Hydraulics & Pneumatics

**Tools**

<img src="https://skillicons.dev/icons?i=git,github,jupyter,linux,vscode&theme=dark" />
...
| Project | Description |
|---|---|
| 🚗 **Autonomous Vehicle Simulation System** | Vehicle control in Gazebo/Isaac Sim — path planning, obstacle detection, real-time perception via TensorFlow/PyTorch *(ongoing)* |
| 🛰️ **[EuroSAT-CNN](https://github.com/Sujalkrishnadas/EuroSAT-CNN)** | Benchmarked 10 CNN architectures for binary satellite image classification of strategic land-use areas (Sentinel-2 imagery) |
| 🎯 **[DETR_OBD](https://github.com/Sujalkrishnadas/DETR_OBD)** | Object detection using DETR (Detection Transformer) |
| 🚧 **[ADL_OD](https://github.com/Sujalkrishnadas/ADL_OD)** | Obstacle detection system for robots and vehicles |
| 🔍 **[Adaptive Surveillance Prioritization System (ASPS)](https://github.com/Sujalkrishnadas/Adaptive-Surveillance-Prioritization-System-ASPS-)** | Intelligent system for prioritizing surveillance feeds/events |
| 🤖 **[ODIKE AI](https://github.com/Sujalkrishnadas/ODIKE_AI)** | Multi-platform AI content generator — converts one idea into platform-specific posts (Instagram, LinkedIn, X, YouTube, Blogs, Shorts) with brand-voice controls |
| 💬 **AI Negotiation & Smart Pricing Platform** | Real-time multilingual buyer-vendor translation with an integrated price-analysis engine, preserving negotiation tone across languages |
| 🧬 **ML Model – AIDS Clinical Trials Analysis** | End-to-end scikit-learn pipeline, 92%+ accuracy — findings published as a peer-reviewed paper |
...
> Snake animation needs a one-time setup — see the note below the summary.
